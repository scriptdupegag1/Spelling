...
local url = "https://raw.githubusercontent.com/scriptdupegag1/Spelling/refs/heads/main/dywl%20list%20full.txt"
...
Instance.new("UICorner", KeyboardFrame).CornerRadius = 
